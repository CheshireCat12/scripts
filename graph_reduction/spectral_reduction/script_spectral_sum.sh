...
#SBATCH --output=/storage/homefs/ag21k209/neo_slurms/spectral_remaining_%A_%a.out
#SBATCH --array=1-120

param_store=./arguments_spectral_reduction.txt
