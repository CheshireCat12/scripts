...
#SBATCH --output=/storage/homefs/ag21k209/neo_slurms/timing_ged_on_baseline_%A_%a.out
#SBATCH --array=1-2

param_store=./arguments_ged_timing.txt
...
srun python main.py --root_dataset $SCRATCH/data/$dataset_save/baseline --n_cores 0 --ks 3 --alphas 0.5 --folder_results $HOME/graph_library/results/ged_timing/$dataset_save/baseline -v
