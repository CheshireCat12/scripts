...
#SBATCH --output=/storage/homefs/ag21k209/neo_slurms/classification_gk_SP_on_baseline_%A_%a.out
#SBATCH --array=1-17
...
srun python main.py --root_dataset $SCRATCH/data/$dataset_save/baseline --graph_kernel SP --n_cores 10 --save_predictions --folder_results $HOME/graph_library/results/gk_SP_classification/$dataset_save/baseline -v
