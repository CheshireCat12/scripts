...
#SBATCH --output=/storage/homefs/ag21k209/neo_slurms/classification_gk_WL_on_baseline_big_%A_%a.out
#SBATCH --array=1-6
...
srun python main.py --root_dataset $SCRATCH/data/$dataset_save/baseline --graph_kernel WL --n_cores 5 --save_gt_labels --save_predictions --folder_results $HOME/graph_library/results/gk_WL_classification/$dataset_save/baseline -v
