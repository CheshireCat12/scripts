...
do
    srun python main.py --root_dataset $SCRATCH/data/$dataset_save/baseline --graph_kernel SP --n_cores 15 --seed $seed --save_gt_labels --save_predictions --folder_results $HOME/graph_library/results/gk_SP_classification/$dataset_save/baseline/1 -v
done
