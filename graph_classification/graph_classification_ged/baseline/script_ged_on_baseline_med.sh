...
srun python main.py --root_dataset $SCRATCH/data/$dataset_save/baseline --n_cores 8 --save_gt_labels --save_predictions --save_distances --folder_results $HOME/graph_library/results/ged_classification/$dataset_save/baseline -v
