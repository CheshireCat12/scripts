...
param_store=./arguments_ged_on_centrality_big.txt
...
srun python main.py --root-dataset $SCRATCH/data/$dataset_name/centrality/$centrality_name/$rho --graph-format pkl --n-trials 10 --n-outer-cv 10 --n-inner-cv 3 --n_cores 10 --save-gt-labels --save-predictions --folder-results $HOME/graph_library/results/ged_classification/$dataset_name/centrality/$centrality_name/$rho -v
